...
export async function POST(
  request: Request,
  context: RouteContext<'/api/boms/[id]/deactivate'>,
  ...
  return withErrorHandling(
    ...
    async (requestId) => {
      ...
      const input = parseDeactivateBomInput(body);
      const result = await deactivateBom(actor, id, input);
