...
import { assertNoQueryParams, submitBom, parseSubmitBomInput } from '@/modules/bom/application';
...
export async function POST(
  request: Request,
  context: RouteContext<'/api/boms/[id]/submit'>,
  ...
  return withErrorHandling(
    ...
    async (requestId) => {
      ...
      const input = parseSubmitBomInput(body);
      const result = await submitBom(actor, id, input);
